...
%= _1\\ _2$.
function [gradUTheta]=robot_potential_totalGrad(thetaEval,world,potential)
Jtheta=jacobianMatrix(thetaEval);
xEval=Kinematics(thetaEval);
% gradUTheta=Jtheta'*potential_totalGrad(xEval.EEF,world,potential);
gradUTheta=pinv(Jtheta)*potential_totalGrad(xEval.EEF,world,potential);
